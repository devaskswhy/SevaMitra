...
export default function IncidentsSection() {
  ...
  // used to handle (this section is now the only place that does).
                    ...
                    >
                      <div style={{ flex: '1 1 300px' }}>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <h4 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>{incident.type}</h4>
                        </div>
                ...
                return (
                  <Card key={incident.id} padding="md" style={{ borderLeft: '4px solid var(--status-green)' }}>
                    <div className="flex justify-between items-start gap-3 flex-wrap">
                      <div>
                        <h4 className="text-lg font-semibold mb-1" style={{ color: 'var(--text-secondary)' }}>{incident.type}</h4>
