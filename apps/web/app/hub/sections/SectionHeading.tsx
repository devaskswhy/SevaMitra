...
/* ═══════════════════════════════════════════════════════════════
   ...
   seven of these on one page instead of one per route).
   ═══════════════════════════════════════════════════════════════ */
export default function SectionHeading({ icon: Icon, title, description, extra }: SectionHeadingProps) {
  return (
    <div
      style={{
        display: 'flex',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
        <Icon size={22} style={{ color: 'var(--saffron)', flexShrink: 0 }} />
        <div>
          <h2
            style={{
